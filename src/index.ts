...
const newNightTeam: Team = new NightTeam(
	"12",
	"Mello",
	"15/01/2020",
	"15/07/2020",
...
const newFullTeam: Team = new FullTimeTeam(
	"13",
	"Mello",
	"15/01/2020",
	"15/07/2020",
...
const newTeacher: Lecturer = new Lecturer(
	"1122",
	"Paulinha",
	"paulinha@labenu.com",
	"12/12/1993",
	[Skills.BACKEND, Skills.CSS, Skills.REACT, Skills.CSS, Skills.TYPESCRIPT]
);
...
// })
const add = new SchoolManager().setLecturerToTeam(
	"12",
	"Mello-na-night",
	"1122",
	"Paulinha"
